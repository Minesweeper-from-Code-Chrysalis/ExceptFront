    ...
    return items.push(
      ...
      >
        <Card className={classes.root} style={{ backgroundColor: "#383737", height: "100%" }}>
          <CardMedia className={classes.cover} image={!shop.image_url.shop_image1 ? NoImage : shop.image_url.shop_image1} title="shop_image" />
